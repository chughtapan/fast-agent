...
def test_curated_helpers_alias_current_helpers(provider: Provider) -> None:
    assert ModelSelectionCatalog.list_curated_aliases(provider) == ModelSelectionCatalog.list_current_aliases(
        provider
    )
    assert ModelSelectionCatalog.list_curated_models(provider) == ModelSelectionCatalog.list_current_models(
        provider
    )
